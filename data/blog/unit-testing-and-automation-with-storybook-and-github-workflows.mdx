...
date: '2025-05-20'
tags: ['XMCloud', 'SitecoreAI', 'Sitecore', 'Storybook', 'SaaS', 'NextJS', 'Unit Testing', 'GitHub Workflows']
draft: false
summary: >
...
In the example below, I’ve intentionally modified a unit test to break it. You can see the live-updated test output in the Interactions window:
