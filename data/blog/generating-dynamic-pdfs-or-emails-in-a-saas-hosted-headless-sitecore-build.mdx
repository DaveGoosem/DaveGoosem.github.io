...
In a headless solution, especially a SaaS hosted one, the way in which you need to look at what has been historically a backend/server-side process (often running in your Content Delivery Sitecore instance) needs to be re-considered.
