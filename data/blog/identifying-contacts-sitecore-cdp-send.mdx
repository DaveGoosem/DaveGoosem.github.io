...
images:
  [
    '/static/images/posts/2022/identifying-contacts-sitecore-cdp-send/CDP_Identify_Banner_Image-13.png',
  ]
authors: ['default']
---
...
<i>
  Note: All sample code in here should not be used directly in production and is Proof of Concept
  only code. This post assumes you have added your Sitecore CDP and Send scripts onto your page
  already and connected each product to your site.
</i>
