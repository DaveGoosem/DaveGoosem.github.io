...
draft: false
summary: Building Headless components for Sitecore XM Cloud has some notable differences in the way you construct your end-to-end component to ensure it supports Pages. This article is an end-to-end walkthrough for a simple CTA Button Component.
layout: DaveLayout
images: []
authors: ['default']
---
...
- There are 7 total XM Cloud "environments" depicted by the coloured stripes labelled with environment names that span the width:
