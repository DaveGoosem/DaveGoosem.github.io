...
![Sample Wildcard page and settings pointing to an item
bucket](/static/images/posts/2019/wildcard-pages-with-item-buckets-and-azure-search/image-1.png
"Sample Wildcard page and settings pointing to an item bucket")
...
![Sample item bucket with a few 'event' items within
it](/static/images/posts/2019/wildcard-pages-with-item-buckets-and-azure-search/image-2.png "Sample
item bucket with a few 'event' items within it")
...
![Model for use within the service
methods](/static/images/posts/2019/wildcard-pages-with-item-buckets-and-azure-search/image-3.png
"Model for use within the service methods")

<em>Below: Code to check if page is a wildcard page</em>
![Code to check if page is a wildcard
page](/static/images/posts/2019/wildcard-pages-with-item-buckets-and-azure-search/image-4.png "Code
to check if page is a wildcard page")

<em>
  Below: Sample code for obtaining data source item from within a bucket by item name defined in URL
  with caching
</em>
![Sample code for obtaining data source item from within a bucket by item name defined in URL with
caching](/static/images/posts/2019/wildcard-pages-with-item-buckets-and-azure-search/image-5.png
"Sample code for obtaining data source item from within a bucket by item name defined in URL with
caching")
