...
![Sample Composbale Sitecore Architecture with an Edge network fronting Vercel](/static/images/posts/2024/securing-non-production-vercel-environments-via-vercel-firewall/image1.png "Sample Composbale Sitecore Architecture with an Edge network fronting Vercel")
